...
## Launch_Format_Conversion_Scaled.sh
## Created by Adrianna Vandeuren on 02/26/2024
...
for file in *_bowtie2.sorted.rmDup.sam 
do
    ...
    sbatch --export=NAME=${OUTNAME} ${jobPath}/Format_Conversion_Job_Scaled.sh
